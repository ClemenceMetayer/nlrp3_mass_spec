...
# df_data concatenation
df_data_serie1 = pd.read_csv("data/Cosinor/cosinor_data/cosinor_data_serie1.csv")
df_data_serie2 = pd.read_csv("data/Cosinor/cosinor_data/cosinor_data_serie2.csv")
df_data_serie3 = pd.read_csv("data/Cosinor/cosinor_data/cosinor_data_serie3.csv")
df_data_serie4 = pd.read_csv("data/Cosinor/cosinor_data/cosinor_data_serie4.csv")
df_data_serie5 = pd.read_csv("data/Cosinor/cosinor_data/cosinor_data_serie5.csv")
df_data_serie6 = pd.read_csv("data/Cosinor/cosinor_data/cosinor_data_serie6.csv")
df_data_serie7 = pd.read_csv("data/Cosinor/cosinor_data/cosinor_data_serie7.csv")

df_data = pd.concat([df_data_serie1, df_data_serie2, df_data_serie3, df_data_serie4, df_data_serie5, 
                        df_data_serie6, df_data_serie7], axis=0)
output_path = 'data/Cosinor/cosinor_data'
filepath = os.path.join(output_path, 'cosinor_data_concat_serie.csv')
